...
const apiId = 8026921;  // get from my.telegram.org // number
...
const investmentAmount = '0.01'; // The amount you want to buy in BNB
...
(async () => {
  ...
  await client.start({
	...
	console.log("You should now be connected. CMC Bot");
